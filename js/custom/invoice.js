      ...
      $(document).ready(function() {
                ...
                let api = "http://localhost/Inverntory-System-Web/pages/config/api/";
                    ...
                    $(document).delegate('#add_invoice', 'click', function(event) {
                      ...
                      $.ajax({
                        ...
                        data: JSON.stringify({'invoice_id': invoice_id, 'product': product, 'product_name': product_name, 'encoded_By': encoded_By, 'total_amount': total_amount, 'status': status}),
                        cache: false,
                ...
                var arr = [];
                  for (var i = 0; i < json.length; i++) {
                      ...
                      obj['invoice_id'] = json[i].invoice_id;
