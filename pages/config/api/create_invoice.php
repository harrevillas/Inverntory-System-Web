...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$product_id = mysqli_real_escape_string($dbConn, $data->product_id);
	...
	$sql = "INSERT INTO  tbl_invoice (`order_id`, `product`, `product_id`, `product_name`, `encoded_By`, `total_amount`, `status`) VALUES('".$order_id."', '".$product."', '".$product_name."', '".$encoded_By."', '".$total_amount."', '".$status."')";
	dbQuery($sql);
}
