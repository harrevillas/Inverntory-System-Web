      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color:#bddcff;">
          <ul class="nav">
              <li class="nav-item">
                  <a class="nav-link" href="../dashboard_guest/dashboard_guest.php">
             ...
             <!-- <li class="nav-item">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="../product/product_guest.php">
                      <i class="ti-shopping-cart menu-icon"></i>
                      <span class="menu-title">Products</span>
                  </a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="../unit/unit_guest.php">
                      <i class="ti-layers menu-icon"></i>
                      <span class="menu-title">Units</span>
                  </a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="../category/category_guest.php">
            ...
            <!--  <li class="nav-item">
                  <a class="nav-link" href="../orders/orders.php">
                      <i class="ti-layers-alt orders-icon"></i>
                      <span class="menu-title">Orders</span>
                  </a>
              </li> -->

 <li class="nav-item">
                  <a class="nav-link" href="../invoice/invoice_guest.php">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="../sales/sales_guest.php">
